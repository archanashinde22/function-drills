...
console.log(exclaimThree(`Exclaim Three Function`));
////////////////// PROBLEM 9 ////////////////////
...
////////////////// PROBLEM 16 ////////////////////
let contestants = ['Katniss', 'Peeta', 'Fox-face', 'Glimmer', 'Cato', 'Rue', 'Thresh', 'Clove', 'Marvel','Glimmer']
let loser = 'Glimmer'
/*
...
convertToUpperCase(sampleString);
...
//CODE HERE
 ...
 {
    let newEmail = email.toString().trim();
 ...
 console.log(emailCheck('   devmountain.com         '));
...
//CODE HERE
function buyChocklateFrogs(gold){
  return gold / 3 ;
}
let totalFrogs = buyChocklateFrogs(90);
console.log(`Total Frog Chocklates ${totalFrogs} `); 
...
//CODE HERE
function buyChocklateFrogs2(gold){
  return parseInt(gold / 3) ;
}
let totalFrogs2 = buyChocklateFrogs2(100);
console.log(`Total Frog Chocklates ${totalFrogs2} `); 

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,5,4,4,5,6,8,9]
/*
